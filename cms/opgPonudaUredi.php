...
if (isset($_POST["sacuvaj"])) {
  $naziv = $_POST['naziv'];
  $opis = $_POST['opis'];
  $stmt = $mysqli->prepare("UPDATE opgponuda set naziv = ?, opis = ? WHERE id = ?");
  $stmt->bind_param("ssi", $naziv, $opis, $id);

  $stmt->execute();

  if (strcmp($row['jezik'], "hrv") == 0) {
        ...
        <div class="row">
          ...
          <div class="col-md-8">
            <div class="contact-form">
              <form method="post" action="opgPonudaUredi.php?id=<?php echo $id ?>">
                <div class="row">
