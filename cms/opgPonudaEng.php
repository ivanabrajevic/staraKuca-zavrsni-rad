...
<html lang="en">
  ...
  <body>
    ...
    ?>
    <section id="opgponuda-eng" style="margin-top: 100px;">
      <h2 style="margin-bottom: 2rem; text-align: center;">Uredi podatke iz OPG ponude na engleskom</h2>
      <div class="container">
      <div class="row">
